...
// ===================================================================
        ...
        public void display() {
          //display game board
                ...
                System.out.println(color(WHITE, background(47), DARK) + "\n=========================" + RESET);
                for (int i = 0; i < _rows; i ++) {
                        for (int n = 0; n < _columns; n ++) {
                                System.out.print(color(WHITE, background(47)) + "|" + RESET + " " + _board[i][n] + " ");
                        }
                        System.out.print(color(WHITE, background(47)) + "|\n" + RESET);
                }
                System.out.println(color(WHITE, background(47), DARK) + "=========================\n" + RESET);
        }
